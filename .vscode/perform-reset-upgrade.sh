...
export FILENAME=$(basename ${ROOT_DIR}/imagebuilder/bin/targets/ath79/generic/openwrt-*-ath79-generic-tplink_archer-c6-v2-squashfs-sysupgrade.bin)
echo $FILENAME
...
ssh root@$OPENWRT_IP sysupgrade -n --force -v /tmp/sysupgrade/$FILENAME
